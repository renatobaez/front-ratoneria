...
return (
  <div className="flex flex-col w-[50%] text-white mx-auto">
    <div className="flex ">
    <form onSubmit={handleSubmit(isSubmit)}className="flex flex-col w-2/3 m-auto gap-5 mt-10 self-center">
        ...
        <select {...register("categoria", { required: true })}
                className="w-[50%] pr-12 pl-3 py-2 text-gray-500 bg-black outline-none border focus:border-porange shadow-sm rounded-lg text-white">
