...
const Title = ({ children }) => (
  <h3 className="pb-3 px-4 font-medium text-gray-100 md:px-8">{children}</h3>
);
...
const Sidebar = () => {
  const lessons = {
    rustLessons: [
      { name: "Comidas", href: "../" },
      { name: "Bebidas", href: "../views/Local" },
    ],
  };

  return (
    <nav className=" top-0 left-0 w-full h-full border-r  bg-pdark-grey space-y-8 overflow-auto">
